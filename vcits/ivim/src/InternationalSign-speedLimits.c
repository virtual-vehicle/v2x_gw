...
asn_TYPE_member_t asn_MBR_InternationalSign_speedLimits_1[] = {
	{ ATF_POINTER, 2, offsetof(struct InternationalSign_speedLimits, speedLimitMax),
		...
		0,
		{ &asn_OER_memb_speedLimitMax_constr_2, &asn_PER_memb_speedLimitMax_constr_2,  memb_speedLimitMax_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct InternationalSign_speedLimits, speedLimitMin),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_speedLimitMin_constr_3, &asn_PER_memb_speedLimitMin_constr_3,  memb_speedLimitMin_constraint_1 },
		0, 0, /* No default value */
		"speedLimitMin"
		},
