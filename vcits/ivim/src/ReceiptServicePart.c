...
static asn_TYPE_member_t asn_MBR_ReceiptServicePart_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ReceiptServicePart, stationLocation),
		...
		0,
		{ &asn_OER_memb_stationLocation_constr_4, &asn_PER_memb_stationLocation_constr_4,  memb_stationLocation_constraint_1 },
		0, 0, /* No default value */
		"stationLocation"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ReceiptServicePart, sessionLocation),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_sessionLocation_constr_5, &asn_PER_memb_sessionLocation_constr_5,  memb_sessionLocation_constraint_1 },
		0, 0, /* No default value */
		"sessionLocation"
		},
