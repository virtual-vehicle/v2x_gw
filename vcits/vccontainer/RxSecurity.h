...
#ifndef	_RxSecurity_H_
#define	_RxSecurity_H_
...
/* RxSecurity */
typedef struct RxSecurity {
	DecapStatus_t	 status;
	ItsAID_t	 itsAID;
	SSPLen_t	 sspLen;
	SSP_t	 ssp;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_RxSecurity;
extern asn_SEQUENCE_specifics_t asn_SPC_RxSecurity_specs_1;
extern asn_TYPE_member_t asn_MBR_RxSecurity_1[4];

#ifdef __cplusplus
}
#endif

#endif	/* _RxSecurity_H_ */
